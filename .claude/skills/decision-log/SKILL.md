---
name: decision-log
description: Lightweight Architecture Decision Records for Nerdy Ad Engine. Use when making significant technical or architectural decisions, when asked about past decisions, or when evaluating trade-offs.
---
