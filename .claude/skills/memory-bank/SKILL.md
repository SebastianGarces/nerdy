---
name: memory-bank
description: Memory bank for cross-session knowledge persistence in Nerdy Ad Engine. Use at the start of every session to load project context, after completing significant work to update progress, when making architectural decisions, or when explicitly asked to "update memory bank".
---
